...
class Pesquisador:
    ...
    data_nasc: Mapped[Optional[date]] = mapped_column(Date)
    ...
    rua: Mapped[Optional[str]] = mapped_column(String(50))
...
class TelefonePesquisador:
    ...
    id_pesquisador: Mapped[int] = mapped_column(ForeignKey('pesquisador.id_pesquisador', ondelete='CASCADE'), primary_key=True)
...
class Pesquisa:
    ...
    data_inicio: Mapped[Optional[str]] = mapped_column(String(50))
    data_fim: Mapped[Optional[str]] = mapped_column(String(50))
...
class Bairro:
    ...
    nome: Mapped[Optional[str]] = mapped_column(String(20))
    id_frequencia: Mapped[int] = mapped_column(ForeignKey('frequencia.id_frequencia'))
...
class Coleta:
    ...
    quantidade_kg: Mapped[Optional[float]] = mapped_column(Float)
