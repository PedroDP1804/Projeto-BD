...
const API_URL = "http://localhost:8000"; // Ajuste se a porta mudar
...
export async function getPesquisadores(): Promise<Pesquisador[]> {
    ...
    const data0 = await res.json() as {pesquisadores:Pesquisador0[]};
    const data = data0.pesquisadores as Pesquisador0[]
    ...
    // Opcional: Converter strings de data ISO para objetos Date reais do JS
    // Isso evita erros de 'date.toLocaleDateString is not a function' no frontend
    // return ret;
}
